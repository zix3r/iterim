  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-slate-200 bg-white shadow-sm">
      <div className="flex h-14 items-center px-4 md:px-6 gap-4">
        ...
        {/* Logo */}
        <Link to="/dashboard" className="flex items-center gap-2 font-bold text-xl text-blue-600 tracking-tight">
            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="relative h-9 w-9 rounded-full ml-1">
                <Avatar className="h-9 w-9 border border-blue-100">
                  <AvatarFallback className="bg-blue-50 text-blue-700 font-semibold">MS</AvatarFallback>
                </Avatar>
              </Button>
            </DropdownMenuTrigger>
