...
export const translations: Record<Language, Translations> = {
  lt: {
    ...
    'notifications.markAllRead': 'Žymėti kaip perskaityta',
    'notifications.empty': 'Nėra pranešimų',
    'notifications.emptyDescription': "Pranešimai pasirodys čia, kai kažkas nutiks",
    'notifications.loading': 'Kraunama...',
    'notifications.unreadBadge': '{count} Neperžiūrėta',
    'notifications.workItemAssigned.title': 'Priskirta užduotis',
    'notifications.workItemAssigned.message': 'Tau priskirta užduotis: "{workItemTitle}".',
    'notifications.blockerResolved.title': 'Užduotis atblokuota',
    'notifications.blockerResolved.message': 'Užduotis "{workItemTitle}" buvo atblokuota — užduotis pavadinimu "{blockerTitle}" buvo atlikta.',
    'notifications.addedToTeam.title': 'Pridėtas/-a',
    'notifications.addedToTeam.message': 'Buvai pridėtas/-a į komandą pavadinimu "{teamName}".',
    'notifications.addedToOrganization.title': 'Pakviestas/-a į organizaciją',
    'notifications.addedToOrganization.message': 'Buvai pakviestas/-a į organizaciją pavadinimu "{organizationName}".',
    'notifications.passwordReset.title': 'Atstatyti slaptažodį',
    'notifications.passwordReset.message': 'Administratorius prašo Jūsų pakeisti slaptažodį. Ieškokite atnaujinimo nuorodos savo pašte.',
    'notifications.preferences.title': 'Pranešimai',
    'notifications.preferences.description': 'Pasirinkite, kuriuos pranešimus norite matyti.',
    'notifications.preferences.master': 'Įjungti pranešimus',
    'notifications.preferences.masterDescription': "Valdomasis jungiklis — išjungus, negausite jokių pranešimų.",
    'notifications.preferences.workItemAssigned': 'Užduočių priskyrimai',
    'notifications.preferences.blockerResolved': 'Blokų pašalinimai',
    'notifications.preferences.addedToTeam': 'Pridėjimai į komandą',
    'notifications.preferences.addedToOrganization': 'Pridėjimai prie organizacijos',
    'notifications.preferences.passwordResetNote': "Slaptažodžių atnaujinimų pranešimai negali būti išjungti.",
    'notifications.preferences.savedToast': 'Pranešimų nustatymai išsaugoti',
    'notifications.preferences.errorToast': 'Nepavyko išsaugoti pranešimų nustatymų',

    // Markdown (TODO: translate to Lithuanian)
    'markdown.helperText': 'Palaiko Markdown formato failus',
    'markdown.tabEdit': 'Redaguoti',
    'markdown.tabPreview': 'Peržiūrėti',
    'markdown.emptyPlaceholder': 'Spustelėkite, norėdami pridėti prierašą...',
    ...
    'dashboard.noBlockedWork': 'Šiuo metu užduotys nėra blokuojamos.',
    'dashboard.blockedBy': 'Blokuoja',
    'dashboard.blockerDone': 'Užbaigta',
    'dashboard.blockerNotDone': 'Neužbaigta',
    'dashboard.unfinishedBlockers': 'Neužbaigtos blokuojančios užduotys',
    ...
    'teams.cannotChangeOwnRole': 'Savo paties vaidmens keisti negalite',
    'teams.cannotChangeCreatorRole': 'Komandos kūrėjo vaidmens pakeisti negalima',
    'teams.cannotChangeOtherAdminRole': 'Šio administratoriaus vaidmenį suprastinti gali tik komandos/produkto kūrėjas arba tas, kuris šį vaidmenį suteikė',
    ...
    'atpa.warnBody': 'Įsitikinkite, kad komandos pravaikštos (atostogos, ligos) yra atnaujintos — algoritmas skaičiuoja pajėgumą pagal jas. Tęsti?',
    'atpa.warnContinue': 'Generuoti',
    'atpa.suggestButton': 'Siūlyti priskyrimus',
    'atpa.title': 'Priskyrimų pasiūlymai',
    ...
    'atpa.partialAppliedToast': 'Dalies siūlymų nepavyko pritaikyti.',
    ...
    'atpa.code.NO_TAG_MATCH': '„{title}" turi žymes, kurių nė vienas narys neturi (nei tiesiogiai, nei pagal užduočių istoriją) — priskirta pagal capacity.',
    'atpa.code.SP_EXCEEDS_CAPACITY': '„{title}" SP ({sp}) yra didesnis nei bet kurio nario likę pajėgumai — apsvarstykite galimybę suskaidyti užduotį.',
    'atpa.code.ALL_MEMBERS_OVERLOADED': 'Nepavyko priskirti „{title}" — visi nariai jau užimti.',
    'atpa.code.MEMBER_OVERLOADED': '{name} pasiekė pajėgumų ribą — naujų užduočių priskirti nebegalima.',

    // ATPA – reason code translations (žymių dalis + capacity dalis)
    'atpa.reason.NO_TAGS_CAPACITY_BASED': 'nėra žymių, sprendimas pagal pajėgumus',
    'atpa.reason.TAG_FULL_MATCH': 'visiškai sutampa žymės',
    'atpa.reason.TAG_PARTIAL_MATCH': 'dalinis žymių sutapimas',
    'atpa.reason.TAG_INFERRED_FULL': 'atitikimas pagal nario užduočių istoriją',
    'atpa.reason.TAG_INFERRED_PARTIAL': 'dalinis atitikimas pagal nario užduočių istoriją',
    ...
    'atpa.reason.CAPACITY_HIGH': 'didžiausi pajėgumai',
    'atpa.reason.CAPACITY_MEDIUM': 'pakankami pajėgumai',
    'atpa.reason.CAPACITY_LOW': 'riboti pajėgumai',

    // ATPA – unassigned reason codes
    'atpa.unassignedReason.OVERSIZED': '„{title}" SP ({sp}) viršija bet kurio nario didžiausius pajėgumus.',
    'atpa.unassignedReason.ALL_FULL': 'Visi nariai pilni arba SP ({sp}) viršija bet kurio nario likusius pajėgumus.',
    'atpa.unassignedReason.ALL_FULL_NO_SP': 'Visi nariai pilni — laisvų pajėgumų nepakanka.',
    ...
    'feedback.field.sprintsUsed': 'Kiek iteracijų naudojotės Iterim?',
    ...
    'feedback.field.acceptablePrice': 'Kokio dydžio kaina būtų jums priimtina už šią sistemą?',
    ...
    'feedback.field.encounteredBugs': 'Ar susidūrėte su sistemos klaidomis (bug\'ais)?',
    ...
    'feedback.admin.markReviewed': 'Pažymėti peržiūrėta',
    'feedback.admin.markUnreviewed': 'Pažymėti neperžiūrėta',
