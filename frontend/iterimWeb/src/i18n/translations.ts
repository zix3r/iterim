...
export const translations: Record<Language, Translations> = {
  lt: {
    ...
    'notifications.workItemAssigned.message': 'Jums buvo priskirtas darbo elementas: „{workItemTitle}“.',
    'notifications.blockerResolved.title': 'Darbo elementas atblokuotas',
    'notifications.blockerResolved.message': 'Darbo elementas „{workItemTitle}“ buvo atblokuotas — blokuojantis elementas „{blockerTitle}“ buvo užbaigtas.',
    'notifications.addedToTeam.title': 'Pridėta prie komandos',
    'notifications.addedToTeam.message': 'Buvote pridėtas prie komandos „{teamName}“.',
    'notifications.addedToOrganization.title': 'Pakviesta į organizaciją',
    'notifications.addedToOrganization.message': 'Buvote pakviestas į organizaciją „{organizationName}“.',
    'notifications.passwordReset.title': 'Slaptažodžio atkūrimas',
    'notifications.passwordReset.message': 'Administratorius inicijavo jūsų paskyros slaptažodžio atkūrimą. Patikrinkite el. paštą dėl atkūrimo nuorodos.',
    'notifications.preferences.title': 'Pranešimai',
    'notifications.preferences.description': 'Pasirinkite, kokius pranešimus norite gauti.',
    ...
    'notifications.preferences.workItemAssigned': 'Darbo elementų priskyrimai',
    ...
    'markdown.helperText': 'Palaiko Markdown formatavimą',
    'markdown.tabEdit': 'Redaguoti',
    'markdown.tabPreview': 'Peržiūra',
    'markdown.emptyPlaceholder': 'Spustelėkite norėdami pridėti aprašymą...',
