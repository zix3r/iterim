...
const STATUS_CONFIG: Record<string, { label: string; color: string }> = {
  Backlog:    { label: 'Backlog',     color: 'bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-400' },
  Todo:       { label: 'To Do',       color: 'bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400' },
  InProgress: { label: 'In Progress', color: 'bg-blue-50 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400' },
  Review:     { label: 'Review',      color: 'bg-purple-50 text-purple-600 dark:bg-purple-900/30 dark:text-purple-400' },
  Done:       { label: 'Done',        color: 'bg-green-50 text-green-600 dark:bg-green-900/30 dark:text-green-400' },
};
