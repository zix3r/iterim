...
public static class EmailTemplates
{
    ...
    public static string EmailChangeConfirmation(string recipientName, string confirmationUrl)
    {
      return EmailChangeConfirmationHtml
        .Replace("{{RECIPIENT_NAME}}", recipientName)
        .Replace("{{CONFIRMATION_URL}}", confirmationUrl)
        .Replace("{{YEAR}}", DateTime.UtcNow.Year.ToString());
    }
...
<body>
  <div class='wrapper'>
    ...
    private const string EmailChangeConfirmationHtml = @"<!DOCTYPE html>
<html lang='lt'>
<head>
  <meta charset='UTF-8' />
  <meta name='viewport' content='width=device-width, initial-scale=1.0' />
